...
app.post('/login', function(req, res) {
  var bool = false;
  console.log("entrou no login", req.body);

  if(req.body['email'] == 'sektor' && req.body['senha'] == 'admin') {
    bool = true;
  }
...
app.post("/cadastrar", function(req, res) {
  var bool = false;
  console.log("cadastrar", req.body);
